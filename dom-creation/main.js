...
function renderPokemon(pokemon) {
  ...
  divRoot.setAttribute('class', 'column-third');
  ...
  divLast.setAttribute('class', 'pokemon-card-text');
  ...
  divLast.appendChild(h2);
  divLast.appendChild(h3);
  divLast.appendChild(description);

  divPokemonCard.appendChild(picture);
  divPokemonCard.appendChild(divLast);

  divRoot.appendChild(divPokemonCard);
